...
![Army fisheye first-person triptych](examples/army-fisheye-first-person-triptych.jpg)

![Courthouse witness triptych](examples/courthouse-witness-triptych.jpg)

![Green water memory triptych](examples/green-water-memory-triptych.jpg)

![Journey West original epic triptych](examples/journey-west-original-epic-triptych.jpg)
