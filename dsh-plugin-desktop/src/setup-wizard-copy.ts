...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    beta: 'Beta',
    title: 'Set up Rouba DSH',
    profile: 'Profile',
    welcomeTitle: 'Welcome to Rouba DSH',
    ...
    presentationBody: 'Choose how Rouba DSH presents the official client.',
    ...
    communityMarketBody: 'The open market built into Rouba DSH, including custom data sources.',
    ...
    successBody: 'Rouba DSH is ready for this Profile.',
    startUsing: 'Start using Rouba DSH',
  ...
  zh: {
    ...
    lanWarningBody: '这样很危险，所有在你局域网内的人都能直接操作你的电脑，请谨慎开启。由于浏览器安全限制，从局域网内使用 HTTP 访问时，部分安全模块可能不可用，可能导致 Rouba DSH 无法正常使用。',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'Rouba DSH 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
    ...
    confirmSkip: '确认跳过',
    successTitle: '设置成功',
    successBody: '这个 Profile 的 Rouba DSH 已准备就绪。',
    startUsing: '开始使用',
