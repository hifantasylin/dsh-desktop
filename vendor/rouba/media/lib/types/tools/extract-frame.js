...
import { appendIndex, extractPublicUrl, resolveSource, workspaceOf } from "./media-asset-save.js";
...
const CATEGORIES = ['upload', 'character', 'scene', 'prop', 'keyframe', 'storyboard', 'cover'];
...
export function registerExtractFrame(ctx) {
    const disposers = [];
    disposers.push(ctx.tools.register(defineTool({
        ...
        async execute(args, exec) {
            ...
            return { kind: 'background', jobId, frames };
        },
        presentCall(args) {
            return {
                card: 'generic',
...
//# sourceMappingURL=extract-frame.js.map