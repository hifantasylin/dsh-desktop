...
import { readActiveAdapter } from "../settings-lookup.js";
import { appendMediaCost } from "../cost-ledger.js";
import { downloadToCache } from "../media-cache.js";
import { workspaceOf } from "./media-asset-save.js";
...
function validateMusicArgs(args) {
    ...
    for (const [field, value] of [['styleWeight', args.styleWeight], ['weirdnessConstraint', args.weirdnessConstraint]]) {
 ...
 */
export function registerGenerateMusic(ctx) {
    const disposers = [];
