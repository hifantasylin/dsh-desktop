...
function imageOf(result) {
    ...
    const attachment = typeof rawAttachment === 'object' && rawAttachment !== null
        && typeof rawAttachment['attachmentId'] === 'string'
        && typeof rawAttachment['mediaType'] === 'string'
        ? {
            attachmentId: rawAttachment['attachmentId'],
            mediaType: rawAttachment['mediaType'],
        }
        : undefined;
    if (attachment === undefined && url === undefined)
        return null;
    return {
        kind: 'image',
...
function videoOf(result) {
    if (result['kind'] !== 'video')
        return null;
    const mediaRef = result['mediaRef'];
    if (typeof mediaRef !== 'object' || mediaRef === null)
        return null;
 ...
 *   media generation.
 */
export function jobOutputMedia(block) {
...
//# sourceMappingURL=job-output-media.js.map