...
async function downloadTo(url, dir, ext, signal) {
    const init = { redirect: 'follow', signal };
...
export function lookupCachedMediaUrl(url) {
...
export function cacheInBackground(options) {
    ...
    void downloadTo(url, dir, ext, signal).then((file) => {
