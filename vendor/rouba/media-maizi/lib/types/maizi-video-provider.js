...
import { getJson, postJson, streamBytes, MaiziHttpError, MaiziNetworkError, httpStatusMeaning } from "./http.js";
import { MAIZI_API_KEY_REF, MissingCredentialError } from "./maizi-image-provider.js";
...
const CAPS_2_0 = { minDuration: 4, maxDuration: 15, maxImageUrls: 9, maxVideoUrls: 3, maxAudioUrls: 3 };
/** Seedance 2.5 系上限（doubao-seedance-2.5）。 */
const CAPS_2_5 = { minDuration: 4, maxDuration: 30, maxImageUrls: 30, maxVideoUrls: 10, maxAudioUrls: 10 };
 ...
 */
class MaiziVideoTaskHandle {
    baseUrl;
    resolveKey;
    taskId;
    lastResultUrls = [];
    lastCostUsd;
    constructor(taskId, baseUrl, 
...
export class MaiziVideoProvider extends VideoProvider {
    ...
    async submit(input, signal) {
        ...
        if (input.returnLastFrame !== undefined)
            payload['return_last_frame'] = input.returnLastFrame;
        if (input.generationType !== undefined)
            payload['generation_type'] = input.generationType;
...
//# sourceMappingURL=maizi-video-provider.js.map