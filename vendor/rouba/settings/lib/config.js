import { DEFAULT_PROVIDER_ID, MEDIA_CATEGORIES, MEDIA_CATEGORY_DEFAULTS, MEDIA_CATEGORY_DEFAULT_ADAPTERS, ROUBAAI_REGISTER_URL, ROUBAAI_SETTINGS_NS, UNSET, defaultProviderEntry, resolveRoubaaiMediaSettings } from "./shared.js";
...
const MediaProviderEntrySchema = z.object({
	id: z.string().default(""),
...
const MediaCategorySettingsSchema = z.object({
...
*/
const RoubaaiMediaSettingsSchema = z.object({
	image: MediaCategorySettingsSchema.default({
		activeId: "default",
		providers: []
	}),
	video: MediaCategorySettingsSchema.default({
		activeId: "default",
		providers: []
	}),
	music: MediaCategorySettingsSchema.default({
		activeId: "default",
		providers: []
	}),
...
//#endregion
export { DEFAULT_PROVIDER_ID, MEDIA_CATEGORIES, MEDIA_CATEGORY_DEFAULTS, MEDIA_CATEGORY_DEFAULT_ADAPTERS, ROUBAAI_REGISTER_URL, ROUBAAI_SETTINGS_NS, RoubaaiMediaSettingsSchema, UNSET, defaultProviderEntry, resolveRoubaaiMediaSettings };
