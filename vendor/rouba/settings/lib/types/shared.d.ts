...
export declare const MEDIA_CATEGORIES: readonly MediaCategory[];
/** The built-in provider id every category is seeded with. */
export declare const DEFAULT_PROVIDER_ID = "default";
/**
 ...
 */
export declare const MEDIA_CATEGORY_DEFAULT_ADAPTERS: Readonly<Record<MediaCategory, string>>;
/** Registration page the built-in image/video providers' key comes from. */
export declare const ROUBAAI_REGISTER_URL = "https://www.maizitech.net/register?invite_code=664KPT";
 ...
 */
export declare const MEDIA_CATEGORY_DEFAULTS: Readonly<Record<MediaCategory, CategoryDefaults>>;
...
export declare function defaultProviderEntry(category: MediaCategory): MediaProviderEntry;
/**
 ...
 */
export declare function resolveRoubaaiMediaSettings(value: unknown): ResolvedRoubaaiMediaSettings;
